---
id: TASK-197
title: 'sbt bug: can''t scroll mouse while entering text in actions bar at bottom.'
status: To Do
assignee: []
created_date: '2026-09-08 16:34'
labels:
  - tui
  - bug
dependencies: []
...
Filed from sbt 0.4.0 while at page=Tasks view=custom filter="status:!done" sort=id:ascending selected=TASK-196 pane=None.

Impact: can't scroll mouse while entering text in actions bar at bottom.
...
│147   In Progress M     Central database across repositories with optional single-file Git sy     agent │
...
│186   To Do       M     sbt idea: enable subtask linking in same menu as parent task linking            │
│193   In Progress H     Add themed navigation badges and an empty Inbox page to sbt               agent │
│194   To Do       M     sbt idea: Show icons on tasks for ready for implementation                      │
│195   To Do       M     sbt idea: create a distributed task system that non-participants can            │
│196   To Do       M     sbt idea: organization level i.e. * no project should persist on scro           │
└────────────────────────────────────────────────────────────────────────────────────────────────────────┘
:bug can't scroll mouse while entering text in actions bar at bottom. ▏
```
...
report Idea TASK-196
action command idea (355.1ms)
action command (0.0ms)
```
