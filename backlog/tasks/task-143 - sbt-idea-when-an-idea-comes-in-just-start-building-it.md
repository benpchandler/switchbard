---
id: TASK-143
title: 'sbt idea: when an idea comes in just start building it'
status: To Do
assignee: []
created_date: '2026-09-03 21:35'
labels:
  - tui
  - idea
dependencies: []
...
Impact: when an idea comes in just start building it
...
└──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
:idea when an idea comes in just start building it▏
```
...
action command (0.0ms)
report Idea 142 in switchbard
action command idea (173.1ms)
action command (0.0ms)
```
