---
id: TASK-176
title: 'sbt idea: enhance the formatting of the tab bar to better differntiate from below'
status: To Do
assignee: []
...
Filed from sbt 0.4.0 while at page=Tasks view=v1 filter="status:!done" sort= selected=TASK-175 pane=None.

Impact: enhance the formatting of the tab bar to better differntiate from below
...
┌ switchbard  v1 · status:!done · hide:done · group:project · 74/138 ────────────────────────────────────┐
...
└────────────────────────────────────────────────────────────────────────────────────────────────────────┘
:idea enhance the formatting of the tab bar to better differntiate from below▏
```
