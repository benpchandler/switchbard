---
id: TASK-146
title: 'sbt idea: make evidence visisble'
status: To Do
assignee: []
created_date: '2026-09-03 21:40'
labels:
  - tui
  - idea
dependencies: []
...
Filed from sbt 0.4.0 while at view=custom filter="" sort= selected=TASK-145 pane=None.

Impact: make evidence visisble
Evidence: screen and action trail below, captured at filing time.

## Screen

```text
┌ switchbard  custom · hide:done · paint:1 · group:project · 50/108 ────────────────────────────────────────────────────────┐
...
action settings
action command (0.0ms)
report Idea TASK-145
action command idea (181.0ms)
action open (0.0ms)
action back (0.0ms)
action command (0.0ms)
```
