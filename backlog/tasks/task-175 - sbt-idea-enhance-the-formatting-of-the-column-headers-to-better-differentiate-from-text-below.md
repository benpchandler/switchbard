---
id: TASK-175
title: 'sbt idea: enhance the formatting of the column headers to better differentiate from text below'
status: To Do
assignee: []
created_date: '2026-09-08 11:35'
labels:
  - tui
  - idea
dependencies: []
...
Filed from sbt 0.4.0 while at page=Tasks view=v1 filter="status:!done" sort= selected=TASK-174 pane=None.

Impact: enhance the formatting of the column headers to better differentiate from text below
...
┌ switchbard  v1 · status:!done · hide:done · group:project · 73/137 ────────────────────────────────────┐
...
└────────────────────────────────────────────────────────────────────────────────────────────────────────┘
:idea enhance the formatting of the column headers to better differentiate from text below▏
```
