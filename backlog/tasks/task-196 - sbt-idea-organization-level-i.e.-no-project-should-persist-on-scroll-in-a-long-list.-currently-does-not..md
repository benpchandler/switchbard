---
id: TASK-196
title: 'sbt idea: organization level i.e. * no project should persist on scroll in a long list. currently does not.'
status: To Do
assignee: []
...
Filed from sbt 0.4.0 while at page=Tasks view=custom filter="status:!done" sort=id:ascending selected=TASK-154 pane=None.

Impact: organization level i.e. * no project should persist on scroll in a long list. currently does not.
...
└────────────────────────────────────────────────────────────────────────────────────────────────────────┘
:idea organization level i.e. * no project should persist on scroll in a long list. currently does not. ▏
```
