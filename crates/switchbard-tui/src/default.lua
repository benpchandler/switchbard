...
return {
  ...
  -- "shift-tab", "pagedown", "pageup", "home", "end", "ctrl-<char>". Actions: down, up, top, bottom, page_down, page_up, open, focus_pane, new_task,
  ...
  keys = {
    ...
    pagedown = "page_down", pageup = "page_up", ["shift-tab"] = "focus_pane",
