...
return {
  ...
  -- back, filter, filter_column, sort_column, columns, paint, ball, done, pass, group, task, settings, view, command, reload, help, quit.
  keys = {
    ...
    c = "columns", p = "paint", b = "ball", d = "done", w = "pass", o = "group", t = "task", v = "view", [","] = "settings", r = "reload", ["?"] = "help", q = "quit",
  },
