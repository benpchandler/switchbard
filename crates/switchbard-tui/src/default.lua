...
return {
  ...
  -- back, filter, filter_column, sort_column, columns, paint, ball, pass, group, task, settings, view, command, reload, help, quit, page, open_browser, dismiss_notifications.
  keys = {
    ...
    c = "columns", p = "paint", b = "ball", w = "pass", o = "group", t = "task", v = "view", [","] = "settings", r = "reload", O = "open_browser", n = "dismiss_notifications", ["?"] = "help", q = "quit",
  },
