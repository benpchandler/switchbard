//! Listeners view — flat or grouped-by-repo/worktree table of attributed
//! listeners, plus the right-side "tracked repos" sidebar and the
...
fn render_sidebar(app: &mut HiveApp, ctx: &egui::Context) {
