...
pub use backlog::{
    ...
    replace_task_section, roll_goals, set_backlog_acceptance_checked, set_backlog_dod_checked,
    ...
    BacklogTaskPatch, BacklogTaskSource, GoalCheckIn, GoalDef, GoalInputs, GoalMeasure, GoalWeek,
...
pub use dispatch::{
    ...
    dismiss_run, release_as_dispatched, release_as_failed, select_batch, sweep_dead_sidecar,
    DispatchOptions,
