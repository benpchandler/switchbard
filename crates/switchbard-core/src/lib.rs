...
pub use backlog::{
    ...
    set_task_label, set_task_list_field, set_task_milestone, set_task_priority, set_task_status,
    set_task_title, swap_backlog_label, swap_task_label, task_file_round_trips,
    write_new_task_file, BacklogChecklistItem, BacklogProject, BacklogTask, BacklogTaskPatch,
    BacklogTaskSource, NewBacklogTask, TaskChecklist, TaskListField, TaskSection, WriteOutcome,
